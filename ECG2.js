...
export const drawToECG2 = (ctx2) => {
    ...
    function drawECG2() {
        ...
        ctx2.lineTo(x,height / 1.2)
        currentTime += 2;

        function drawSegment2() {
          if (currentTime >= duration) {
            // get the next frame
            requestAnimationFrame(drawECG2);
            return;
          }
          ...
          ctx2.clearRect(x, 8, 2, 270);
          ctx2.lineWidth = 2;
          ctx2.strokeStyle = "lightgreen";
          ctx2.bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y);
          currentTime++;
          if(z){
          ...
          prevY = y;
          prevSlope = slope;
          requestAnimationFrame(drawSegment2);
        }
